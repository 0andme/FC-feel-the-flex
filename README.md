...
API 분석 후 어떤 프로젝트로 진행/완성할 것인지 팀 단위로 결정하세요.<br>
API 사용에 대해 궁금한 점은 슬랙 '질의응답' 채널에 질문 남겨주세요!<br>
API 동작에 문제가 발생하면, 바로 박영웅 강사에게 연락주세요!

오타 및 잘못된 내용 제보 받습니다.<br>
[이슈](https://github.com/KDT1-FE/JS-Mission-Team/issues/new)에 추가해 주시면 바로 반영하겠습니다!

- 과제 기간: 11월 10일(수) ~ 11월 17일(수)
- 리뷰 기간: 11월 17일(수) ~ 11월 24일(수)
