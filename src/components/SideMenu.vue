<template>
  <!-- 모달 -->
  <FullscreenModal v-model="isShow" :modal-name="modalName">
    <template #activator>
      <div class="user_profile main" @click.stop="isShow = true">
    ...
    <template #default>
      ...
      <div class="menu_container">
        ...
        <div class="menu_list">
          ...
          <!-- 설정 페이지 -->
          <RouterLink to="settings" class="menu_item" @click="isShow = false">
            ======= v-if="!isMaster" to="/myaccount" class="menu_item"
            @click.stop="isShow=false"> 계좌 관리
          </RouterLink>
          <!-- 제품 관리 -->
          <RouterLink
            v-if="isMaster"
          ...
          <RouterLink
            ...
            @click.stop="isShow = false"
          >
            >>>>>>> 47e40b864cdad04d50094927c24cb5c0fda644de 설정
          </RouterLink>
        </div>
        <div class="devider"></div>
        <!-- 로그아웃 -->
        <a class="menu_item" <<<<<<< HEAD @click="userLogOut">
          ======= @click.stop="userLogOut"> >>>>>>>
          47e40b864cdad04d50094927c24cb5c0fda644de 로그아웃
        </a>
      </div>
    </template>
  </FullscreenModal>
